// The opening block of body copy, with its image and stat figures.
//
...
import { Intro as IntroSection } from "../../../_ServiceLayout";

export default function Intro({ data }) {
  return <IntroSection intro={data && typeof data === "object" ? data : {}} />;
}
